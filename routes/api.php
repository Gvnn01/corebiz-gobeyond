...
Route::get('listagem-pessoa', 'APIPessoasController@listagemDePessoas')
->middleware('authenticate-api');

//? Rota para listagem de pessoa por id.
Route::get('listagem-pessoa/{id}', 'APIPessoasController@listagemDePessoasById')
->middleware('authenticate-api');
...
Route::post('item-desafio', 'ChallengeController@challengeCorebiz')
->middleware('cache-challenge');
